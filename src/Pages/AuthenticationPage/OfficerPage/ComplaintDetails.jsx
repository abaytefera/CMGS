...
import {
  ...
  Download, Paperclip, Mail, Phone, Image as ImageIcon, ExternalLink
} from "lucide-react";
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              <div className="lg:col-span-2 space-y-8">
                ...
                {/* ATTACHMENTS SECTION - CHECKING FILE TYPE */}
                <InfoCard title="Evidence & Attachments">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    {complaint.Attachments && complaint.Attachments.length > 0 ? (
                      complaint.Attachments.map((file) => (
                        <div key={file.id} className="group flex items-center justify-between p-4 bg-white border border-slate-200 rounded-2xl hover:border-emerald-500 transition-all">
                          <div className="flex items-center gap-3 overflow-hidden">
                            ...
                            <div className="flex flex-col overflow-hidden">
                              <span className="text-[11px] font-black text-slate-900 truncate uppercase">{file.original_name}</span>
                              <span className="text-[9px] text-slate-400 font-bold uppercase">{file.file_type.split('/')[1]}</span>
                            </div>
                          </div>
                          <button 
